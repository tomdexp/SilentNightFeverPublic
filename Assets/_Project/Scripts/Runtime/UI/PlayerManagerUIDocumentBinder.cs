...
namespace _Project.Scripts.Runtime.UI
{
    public class PlayerManagerUIDocumentBinder : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (_uiDocument == null)
            {
                Utils.Logger.LogError("No UIDocument found on PlayerManagerUIDocumentBinder.");
                return;
            }
            ...
            {
                Utils.Logger.LogError("PlayerManagerUIDocumentBinder: One of the player labels is null.");
                return;
            }
            if (_possessedPlayersLabel == null)
            {
                Utils.Logger.LogError("PlayerManagerUIDocumentBinder: Possessed players label is null.");
                return;
            }
        ...
        private IEnumerator BindEvents()
        {
            ...
            Utils.Logger.LogTrace("PlayerManagerUIDocumentBinder: PlayerManager found. Binding events.");
        }
        ...
        private void UnbindEvents()
        {
            ...
            PlayerManager.Instance.OnRealPlayerPossessed -= OnRealPlayerPossessed;
            PlayerManager.Instance.OnRealPlayerUnpossessed -= OnRealPlayerUnpossessed;
            Utils.Logger.LogTrace("PlayerManagerUIDocumentBinder: Unbinding events.");
        }
